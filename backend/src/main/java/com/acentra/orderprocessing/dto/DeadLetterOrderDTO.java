...
public class DeadLetterOrderDTO {
    private Long id;
    ...
    public DeadLetterOrderDTO() {}

    public DeadLetterOrderDTO(Long id, String orderId, String failureReason, Integer retryCount, Instant lastAttemptAt, String payloadJson, DlqStatus status, Instant createdAt) {
        this.id = id;
    ...
    public static class Builder {
        ...
        public DeadLetterOrderDTO build() {
            return new DeadLetterOrderDTO(id, orderId, failureReason, retryCount, lastAttemptAt, payloadJson, status, createdAt);
        }
    }
